...
async def run_quick_signal_engine(session: AsyncSession, symbol: str) -> dict[str, Any]:
    ...
    impulse_bullish_ready = (
        ...
        and (bullish_breakout or strong_bullish_3m or (momentum_3m is not None and momentum_3m > 0))
        and not trap_bull
        and short_covering_risk_bull < 70
        and (breadth_bullish_ok or not breadth_snapshot.available)
    ...
    impulse_bearish_ready = (
        ...
        and (bearish_breakdown or strong_bearish_3m or (momentum_3m is not None and momentum_3m < 0))
        and not trap_bear
        and short_covering_risk_bear < 70
        and (breadth_bearish_ok or not breadth_snapshot.available)
    ...
    bullish_signal_type = "impulse_scalp" if impulse_bullish_ready and not bullish_ready_base else "structure_breakout"
    bearish_signal_type = "impulse_scalp" if impulse_bearish_ready and not bearish_ready_base else "structure_breakout"
